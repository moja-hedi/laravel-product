...
class CreateProductTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('attribute_templates', function (Blueprint $table) {
            ...
            $table->primary(['template_id', 'attribute_id']);
        ...
        Schema::create('attribute_value_template_attribute_lines', function (Blueprint $table) {
            $table->bigInteger('attribute_value_id');
            $table->bigInteger('template_attribute_line_id');

            $table->primary(['attribute_value_id', 'template_attribute_line_id']);

            $table->foreign('attribute_value_id')->references('id')->on('attribute_values')->onUpdate('CASCADE')->onDelete('NO ACTION');
            $table->foreign('template_attribute_line_id')->references('id')->on('template_attribute_lines')->onUpdate('CASCADE')->onDelete('NO ACTION');
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('attribute_value_template_attribute_lines');
